<template>
    ...
    <div style="padding: 10px">
        <div style="width: 400px;margin: 0 auto;background-color: indigo; border-radius:10px">
            <div style="color: #1be620; font-size: 40px; text-align: center;padding: 5px 0;">用户日志</div>
        </div>
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="usermd5" label="用户ID" width="350px" sortable=""/>

            <el-table-column prop="filmid" label="电影ID" sortable=""/>

            <el-table-column prop="rate" label="操作"/>

            <el-table-column prop="generatetime" label="日期" sortable=""/>
            ...
            <el-dialog v-model="dialogVisible" title="表单信息" width="30%">
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item label="日期">
                        <el-date-picker v-model="form.generatetime" type="date" format="YYYY/MM/DD" style="width: 80%"></el-date-picker>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                if (this.form.id) {
                    //更新
                    request.put("/adminuserlog", this.form).then(res => {
                        console.log(res);
                        if (res.code === '0') {
                    ...
                    // 新增
                    request.post("/adminuserlog", this.form).then(res => {
                        console.log(res);
                        if (res.code === '0') {
                            this.$message.success("更新成功")
                        } else {
            ...
            handleDelete(id) {
                ...
                request.delete("/adminuserlog/" + id).then(res => {
